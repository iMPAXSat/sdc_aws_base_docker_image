...
Seeing as how you're a maintainer, you should be completely on top of the basic `git workflow <https://docs.astropy.org/en/stable/development/workflow/development_workflow.html#development-workflow>`_.
...
`Instructions on how to write a changelog. <https://github.com/sunpy/sunpy/blob/amain/changelog/README.rst>`__.
...
**Next Steps:**
Before making that first Pull Request, check out our :ref:`coding_standards` guide